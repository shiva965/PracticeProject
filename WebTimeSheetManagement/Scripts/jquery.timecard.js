$(document).ready(function ()
{
    ...
    DisableonLoad();
    /* we created  
     *var currentdate  for to show the current date  in from date textfield */
    /*    var mydate = (new Date()).toISOString().split('T')[0];*/
    var mydate = new Date();
    
    var item = mydate.getMonth();
    var item1 = mydate.getDate();
    if (item < 9)
    {
        if (item1 < 10)
        {
            var currentdate = ('0'+mydate.getDate() + '-' + 0+(mydate.getMonth() + 1) + '-' + mydate.getFullYear());
        }
        else
        {
            var currentdate = (mydate.getDate() + '-' + 0 + (mydate.getMonth() + 1) + '-' + mydate.getFullYear());
        }
    ...
    {
        if (item1 < 10) {
            var currentdate = ('0' + mydate.getDate() + '-' + (mydate.getMonth() + 1) + '-' + mydate.getFullYear());
        }
    ...
    ////}
    ////var months = new Array("01", "02", "03", "04",
    ////    "05", "06", "07", "08", "09",
    ////    "10", "11", "12");

    ////$("#datepicker_start").val( months[date.getMonth()] + "-" +
    ////    date.getDate() + "-" + date.getFullYear());
    
    $("#datepicker_start").val(currentdate);
   /* $("#datepicker_start").CalEnd();*/
   ...
   /* $("#datepicker_start").css({ 'display': 'block', 'background-color': '#2ECC40' })*/
...
function CalEnd() {
    ...
    var newFromDate = new Date(FromArray[2], FromArray[1] - 1, FromArray[0]);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data != '')
            {
                ...
                CalEnd();
                $("#_panelmain").show();
                /* we added this below lines*/
                var d1 = data[0].ListofProjectNames[0].ProjectID;
                var d2 = data[0].ListofProjectNames[0].ProjectName;
                var dl1 = "<option value='" + d1 + "'>" + d2 + "</option>"
                $("#ProjectID1").html(dl1);
                $("#text1_p1").val(data[0].ListTimeSheetDetails[0].Hours);
                $("#text2_p1").val(data[0].ListTimeSheetDetails[1].Hours);
                $("#text3_p1").val(data[0].ListTimeSheetDetails[2].Hours);
                $("#text4_p1").val(data[0].ListTimeSheetDetails[3].Hours);
                $("#text5_p1").val(data[0].ListTimeSheetDetails[4].Hours);
                $("#text6_p1").val(data[0].ListTimeSheetDetails[5].Hours);
                $("#text7_p1").val(data[0].ListTimeSheetDetails[6].Hours);
                TotalP1(); //Existing methods were used//
                $("#Description_p1").val(data[0].description[0].Description);

                var d3 = data[0].ListofProjectNames[1].ProjectID;
                var d4 = data[0].ListofProjectNames[1].ProjectName;
                var dl2 = "<option value='" + d3 + "'>" + d4 + "</option>"
                $("#ProjectID2").html(dl2);
                $("#text1_p2").val(data[0].ListTimeSheetDetails[7].Hours);
                $("#text2_p2").val(data[0].ListTimeSheetDetails[8].Hours);
                $("#text3_p2").val(data[0].ListTimeSheetDetails[9].Hours);
                $("#text4_p2").val(data[0].ListTimeSheetDetails[10].Hours);
                $("#text5_p2").val(data[0].ListTimeSheetDetails[11].Hours);
                $("#text6_p2").val(data[0].ListTimeSheetDetails[12].Hours);
                $("#text7_p2").val(data[0].ListTimeSheetDetails[13].Hours);
                TotalP2();
                $("#Description_p2").val(data[0].description[1].Description);

                var d5 = data[0].ListofProjectNames[2].ProjectID;
                var d6 = data[0].ListofProjectNames[2].ProjectName;
                var dl3 = "<option value='" + d5 + "'>" + d6 + "</option>"
                $("#ProjectID3").html(dl3);
                $("#text1_p3").val(data[0].ListTimeSheetDetails[14].Hours);
                $("#text2_p3").val(data[0].ListTimeSheetDetails[15].Hours);
                $("#text3_p3").val(data[0].ListTimeSheetDetails[16].Hours);
                $("#text4_p3").val(data[0].ListTimeSheetDetails[17].Hours);
                $("#text5_p3").val(data[0].ListTimeSheetDetails[18].Hours);
                $("#text6_p3").val(data[0].ListTimeSheetDetails[19].Hours);
                $("#text7_p3").val(data[0].ListTimeSheetDetails[20].Hours);
                TotalP3();
                $("#Description_p3").val(data[0].description[2].Description);
                $("#ProjectID1").attr('disabled', true);
               /* DisableonLoad();*/
                $("#_panelmainbutton").hide();
...
function ValidateData() {
    ...
    else
    {
        ...
        /* we added below lines  for not saving the data while click on the popup cancel button*/
    else
    {
        return false;
    }
